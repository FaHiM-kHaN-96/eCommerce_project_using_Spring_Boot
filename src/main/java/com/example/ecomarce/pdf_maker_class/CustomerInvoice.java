...
public class CustomerInvoice {
    public static byte[] generateCustomerInvoice(List<OrderTableEN> orders) throws Exception {
        ...
        for (Map.Entry<String, List<OrderTableEN>> entry : ordersByInvoice.entrySet()) {
            ...
            // Add watermark
            ColumnText.showTextAligned(canvas, Element.ALIGN_CENTER, new Phrase("Invoice", watermarkFont),
                    297.5f, 421, 45);
